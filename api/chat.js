...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = {
      role: 'system',
      content: `Bạn là Kami, một AI thông minh và thân thiện được tạo ra bởi Nguyễn Đức Thạnh. Hãy trả lời bằng tiếng Việt tự nhiên và không lặp lại nội dung đã nói một cách liên tục. Có thể thêm emoji tùy ngữ cảnh để trò chuyện thêm sinh động.
